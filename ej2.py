...
if x > 0 :
	...
	print ("Importante...en este ejercicio ya transforme el codigo de python2 a python3, las dos diferencias que generaban error al compilar el codigo hecho con python2 con python3 fueron que ahora en python 3 print es una funcion y hay que ponerle () y lo otro fue que en python3 input es una cadena de texto, para poder usar los numeros tuve que convertir con int antes de input")
