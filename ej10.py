...
an old exercise (see Exercise 5), except require
...
lists (without duplicates). Make sure your program works
on two lists of different sizes. Write this in one line of
Python using at least one list comprehension.
(Hint: Remember list comprehensions from Exercise 7).
"""
a = [1, 2, 3, 4, 5, 6, 7, 8, 9, 1, 11, 55, 89]
